...
const Footer = () => {
    return (
        <div className='text-gray-200 mt-auto flex flex-col bg-zinc-800 py-8 px-3 md:px-8 lg:px-12 w-full'>
            <div className='lg:flex justify-between gap-6'>
                <div className=' text-2xl font-semibold text-wrap lg:w-1/2 mb-5'>Top companies choose <span className='text-sky-300'>J2C Business</span> to build in-demand career skills.</div>
