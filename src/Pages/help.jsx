        ...
        <div className="flex justify-center">
          <div className="flex justify-center w-[14rem] sm:w-[16rem]  lg:w-[26rem] border-[1px] rounded-md border-black mt-12 items-ceter">
            <div
              ...
              className={`text-center text-xl sm:text-2xl lg:text-4xl rounded-l-md py-3 w-1/2 cursor-pointer ${
                activeTab === "subscriber" ? "bg-blue-700 text-white" : ""
              }`}
            >
              Subscriber
            </div>
            <div
              ...
              className={`text-center text-xl sm:text-2xl lg:text-4xl rounded-r-md py-3 w-1/2 cursor-pointer ${
                activeTab === "instructor" ? "bg-blue-700 text-white" : ""
              }`}
            >
              Instructor
            </div>
