          ...
          <div className="flex items-center w-full justify-between">
            <div className="flex space-x-4 items-center">
              ...
              <form
                ...
                className="relative h-12 w-[25rem] items-center flex rounded-full p-1 text-gray-800 border-2 border-blue-500"
              >
            ...
            <div className="flex items-center">
              ...
              <Link
                to="/help"
                className={`px-3 py-2 text-sm md:hidden lg:block font-medium ${
                  false
                    ? "text-gray-900"
                    : "text-gray-800 hover:text-white hover:bg-gray-700 rounded-md"
                }`}
                // onClick={() => {
              ...
              <div
                className="flex items-center justify-end space-x-6 sm:ml-6 sm:space-x-4"
                onClick={() => setShowDropdown(false)}
              >
                <div className="flex items-center">
                  <Link
